...
latex_documents = [
    ("index", "DataCite.tex", "DataCite Documentation", "Invenio Software", "manual"),
]
...
man_pages = [("index", "datacite", "DataCite Documentation", ["Invenio Software"], 1)]
